...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/updateFertilizerInformation" method="post">
        <input type="hidden" name="fertilizerId" value="${list.getFertilizerId()}"/>
        化肥名称：<input type="text" name="fertilizerName" value="${list.getFertilizerName()}"/> <br><br>
